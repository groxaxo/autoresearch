...
def get_gpu_vram_gb():
    return int(os.environ.get("GPU_VRAM_GB", "0"))
...
def mutate_config(cfg, space, run_idx, rng, target_gpu_vram_gb=0):
    ...
    if run_idx <= 20:
        ...
        cfg["packing"] = True
        cfg["max_seq_length"] = 1024 if target_gpu_vram_gb == 12 else 2048
...
def main():
    ...
    target_gpu_vram_gb = get_gpu_vram_gb()
    ...
    cfg = mutate_config(cfg, space, run_idx, rng, target_gpu_vram_gb=target_gpu_vram_gb)
